...
\begin{frame}[t]
%todo: smisli neki escape code koji ce napraviti nesto kul i napisi ovdje
\frametitle{Terminal}
\begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Primjer: \texttt{ls --help} \textbf{ili}
          \texttt{ls -h}
  \end{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item Primjer
  	  %todo: od svih datoteka zašto baš sym link???
  \item[] \small\texttt{\$ ls -l /bin/sh}
  \item[] \small\texttt{lrwxrwxrwx 1 root root 4 2010-04-29 10:44 /bin/sh
                        -> bash}
...
%todo: pogledaj je li ovo doista potrebno
\begin{frame}[t]
\frametitle{Prikaz sadržaja direktorija}
\begin{itemize}
